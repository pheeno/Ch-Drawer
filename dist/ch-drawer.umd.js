...
var update = add("5d623b74", content, true, {"sourceMap":false,"shadowMode":false});
...
var DrawerController = {
  ...
  registerInstance: function registerInstance(assemble) {
    if (instanceAssemble.length === 0) {
      ...
      !instanceAssemble.some(function (ins) {
        return ins.instance.id === assemble.id;
      }) && instanceAssemble.push(assemble);
      this.increaseZ();
    }
  ...
  increaseZ: function increaseZ() {
    ++this.zNumber;
  },
  minusZ: function minusZ() {
    --this.zNumber;
  },
  getCurrentZ: function getCurrentZ() {
    return this.zNumber;
  }
};
var DrawerMixin = {
